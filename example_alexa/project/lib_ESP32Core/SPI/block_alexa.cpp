 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Dec 05 12:19:09 2023
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                block_alexa
...
#define SOURCEFILES                    "__SFB__INC_PATH ../lib_WiFI/src__SFB__INC_PATH ../lib_ESP32Core/src__SFB__"
...
extern void block_alexa_Start_wrapper(void);
extern void block_alexa_Outputs_wrapper(const real_T *u0,
  real_T *y0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  block_alexa_Outputs_wrapper(u0, y0);
}
